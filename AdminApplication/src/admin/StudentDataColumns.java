...
public class StudentDataColumns {
	...
	abstract class ColumnDataHandler {
		...
		public boolean isAlwaysVisible() {
			if (this.getClass().getSimpleName().equals("Student_Name"))
				return true;
			return false;
		}
